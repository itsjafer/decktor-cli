...
DeckTor is a command-line tool to improve your Anki decks using LLMs like Gemini, ChatGPT, or Claude. It processes cards in batches to fix errors, improve clarity, or add content, giving you somewhat granular control over your flashcards.
